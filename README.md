...
This brief workshop is intended to encourage others to think about and play with data, using [Python](https://docs.python.org/3/tutorial/index.html) as a facilitation tool. This workshop is not meant to create experts, represent the QEP/Data Nexus, or serve as a rulebook. 
